 ...
 * сверху — заголовки актов. Полоса занимает собственную высоту в потоке
 * документа, поэтому перекрыть контент физически не может, а `sticky` держит её
 * в кадре при прокрутке.
 *
...
export function DebugBar() {
  ...
  return (
    <div className="sticky top-0 z-50 flex flex-col gap-1.5 border-b border-alarm/40 bg-alarm/15 px-4 py-2 backdrop-blur-sm">
